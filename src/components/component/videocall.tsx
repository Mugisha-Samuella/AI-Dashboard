    ...
    <div className="flex flex-col min-h-screen bg-background">
      <header className="flex items-center justify-between px-6 py-4 border-b">
        <Link href="#" className="flex items-center gap-2" prefetch={false}>
          ...
          <span className="text-lg font-semibold">Mental Health Consultation</span>
        </Link>
      </header>
              ...
              <div className="grid gap-4">
                ...
                <div className="bg-muted rounded-lg p-4">
                  <p className="text-muted-foreground text-sm">
                    Hello, John. I'm ready to start our video consultation. How are you feeling today?
                  </p>
                </div>
              </div>
              <div className="mt-4">
                <div className="flex justify-center">
                  <Button className="w-full max-w-md">Start Video Call</Button>
                </div>
              </div>
            </div>
          </div>
